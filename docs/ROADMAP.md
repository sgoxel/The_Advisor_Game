...
- `WP-S003-005-006` — Runtime Building + Tree Material/Texture Lifetime Stability — IN PROGRESS (runtime lifetime fix implemented/deployed; VISUAL 8.3/10 PASS; final functional validation pending after 3-attempt evidence limit)
