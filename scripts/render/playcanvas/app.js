...
function create({backendPreference="webgl2",maxPixelRatio=null,renderScale=null}={}){
  ...
  function terrainChunkSignature(){
    ...
    return "geometry=heightfield-v14-exaggerated-cliff-breaks|seed="+String(lastRawSeed||"none");
  }
  ...
  function terrainMeshMetrics(){
    ...
    return Object.freeze({
      ...
      landformVersion:String(generatorStats.landformVersion||"macro-landform-v5"),
      ...
      landformSteepFaceTreatment:String(generatorStats.landformSteepFaceTreatment||"exaggerated-heightfield+raised-cliff-breaks"),
