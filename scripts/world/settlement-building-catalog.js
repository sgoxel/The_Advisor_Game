...
const CATALOG=Object.freeze([
  ...
  def({id:"stable-road-service",category:"transport",label:"Stable / Road Service",classes:classes(ALL_CLASSES),populationMin:35,capacity:700,maxCount:90,enterable:true,assetKey:"building:function:stable-road-service",road:"local",publicSpace:"none",modifiers:def({route:0.46,trade:0.18,market:0.10}),threshold:0.40}),
